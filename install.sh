...
echo
echo "阿里云盘转存目录folder_id，folder_id获取方式教程：https://www.aliyundrive.com/s/rP9gP3h9asE"
...
echo "开始生成配置文件docker-compose.yml..."
curl -#Lo "$install_path/docker-compose.yml" "${DOWNLOAD_URL}/docker-compose.yml"
if [ "${update}" != "2" ]; then
